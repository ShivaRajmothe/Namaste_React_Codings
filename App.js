...
var ResturantCard =(resData) =>{
    ...
    return(
        ...
        <div className="resturant-card" style={stylecard}>
            ...
            <img  className="resturant-img" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_600/FOOD_CATALOG/IMAGES/CMS/2025/2/21/82cea536-1d0b-4e01-85bd-e11f3f153356_1d50f51c-f3e5-45f4-805e-14d46e293e3d.jpg"/>
  <h3>{name}</h3>
  <h4>{cuisines}</h4>
    ...
    return(
        <div className="body">
            ...
            <div className="resturant-list">
                {
                    restrautList.map((res) => {
                        return <ResturantCard key={res.data.id} {...res.data} />
                    })
                }
