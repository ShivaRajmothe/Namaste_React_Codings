...
fetchData()
 ...
 return res.recipes.name.toLowerCase()
 ...
 Search
            ...
            onClick={() => {
              const  restaurantsfilterData = listOfResturants.filter((res) => res.recipes.rating > 4.5); 
            setListOfResturants(restaurantsfilterData)
            console.log("filter" + restaurantsfilterData) }}>Top Rated Resturant</button>
            </div>
            <div className="resturant-list">
                {
                    filterResults.map((res) => {
                        return <ResturantCard key={res.recipes.id} {...res.recipes} />
                    })
                }
